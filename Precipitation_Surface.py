...
MQTT_TOPIC = [(f"dvpg/msa/tower/1/surface/precipitations", 0), (f"dvpg/msa/tower/2/surface/precipitations", 0),
                (f"dvpg/msa/tower/3/surface/precipitations", 0),(f"dvpg/msa/tower/4/surface/precipitations", 0),
              (f"dvpg/msa/tower/5/surface/precipitations", 0),(f"dvpg/msa/tower/6/surface/precipitations", 0),
              (f"dvpg/msa/tower/7/surface/precipitations", 0), (f"dvpg/msa/tower/8/surface/precipitations", 0),
              (f"dvpg/msa/tower/9/surface/precipitations", 0), (f"dvpg/msa/tower/10/surface/precipitations", 0),
              (f"dvpg/msa/tower/11/surface/precipitations", 0),(f"dvpg/msa/tower/12/surface/precipitations", 0),]

class PrecipitationsSensorData(NamedTuple):
    timestamp: str
    latitude: str
    longitude: str
    Altitude: float
...
def parse_mqtt_message(topic,payload):
    ...
    if sensorType=='soil':
        ...
        return PrecipitationsSensorData(time_stamp, latitude, longitude, altitude, tower, sensorType,measurement,measurement_value1,measurement_value2,measurement_value3,measurement_value4,measurement_value5)
...
outfile=open('./precipitationsData.txt','w')
client = mqtt.Client()
