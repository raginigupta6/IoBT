...
MQTT_TOPIC = [(f"dvpg/msa/tower/1/height/200/sonic", 0), (f"dvpg/msa/tower/2/height/200/sonic", 0),
              (f"dvpg/msa/tower/4/height/200/sonic", 0), (f"dvpg/msa/tower/6/height/200/sonic", 0),
              (f"dvpg/msa/tower/7/height/200/sonic", 0), (f"dvpg/msa/tower/8/height/200/sonic", 0),
              (f"dvpg/msa/tower/9/height/200/sonic", 0), (f"dvpg/msa/tower/10/height/200/sonic", 0),
              (f"dvpg/msa/tower/11/height/200/sonic", 0)]
...
outfile=open('/home/monet/PycharmProjects/MQTTSubscriber/mysonic200second.txt','w')
client = mqtt.Client()
