...
MQTT_TOPIC = [(f"dvpg/msa/tower/1/enclosure/cr6", 0), (f"dvpg/msa/tower/2/enclosure/cr6", 0),
            (f"dvpg/msa/tower/3/enclosure/cr6", 0), (f"dvpg/msa/tower/4/enclosure/cr6", 0),
              (f"dvpg/msa/tower/5/enclosure/cr6", 0), (f"dvpg/msa/tower/6/enclosure/cr6", 0),
              (f"dvpg/msa/tower/7/enclosure/cr6", 0), (f"dvpg/msa/tower/8/enclosure/cr6", 0),
              (f"dvpg/msa/tower/9/enclosure/cr6", 0), (f"dvpg/msa/tower/10/enclosure/cr6", 0),
              (f"dvpg/msa/tower/11/enclosure/cr6", 0), (f"dvpg/msa/tower/12/enclosure/cr6", 0)]

class EnclosureSensorData(NamedTuple):
    timestamp: str
    latitude: str
    longitude: str
    Altitude: float
...
def parse_mqtt_message(topic,payload):
    ...
    if sensorType=='soil':
        ...
        return EnclosureSensorData(time_stamp, latitude, longitude, altitude, tower, sensorType,measurement,measurement_value1,measurement_value2,measurement_value3,measurement_value4,measurement_value5)
...
outfile=open('./EnclosureData.txt','w')
client = mqtt.Client()
