...
MQTT_TOPIC = [(f"dvpg/msa/tower/1/surface/soil", 0), (f"dvpg/msa/tower/2/surface/soil", 0),
            (f"dvpg/msa/tower/3/surface/soil", 0), (f"dvpg/msa/tower/4/surface/soil", 0),
              (f"dvpg/msa/tower/5/surface/soil", 0), (f"dvpg/msa/tower/6/surface/soil", 0),
              (f"dvpg/msa/tower/7/surface/soil", 0), (f"dvpg/msa/tower/8/surface/soil", 0),
              (f"dvpg/msa/tower/9/surface/soil", 0), (f"dvpg/msa/tower/10/surface/soil", 0),
              (f"dvpg/msa/tower/11/surface/soil", 0), (f"dvpg/msa/tower/12/surface/soil", 0)]

class SoilSurfaceSensorData(NamedTuple):
    timestamp: str
    latitude: str
    longitude: str
    Altitude: float
...
def parse_mqtt_message(topic,payload):
    ...
    if sensorType=='soil':
        ...
        return SoilSurfaceSensorData(time_stamp, latitude, longitude, altitude, tower, sensorType,measurement,measurement_value1,measurement_value2,measurement_value3,measurement_value4,measurement_value5)
...
outfile=open('./soilSurfaceData.txt','w')
client = mqtt.Client()
