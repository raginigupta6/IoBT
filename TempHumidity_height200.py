...
MQTT_TOPIC = [(f"dvpg/msa/tower/1/height/200/tempandhumidity", 0), (f"dvpg/msa/tower/2/height/200/tempandhumidity", 0),
            (f"dvpg/msa/tower/3/height/200/tempandhumidity", 0), (f"dvpg/msa/tower/4/height/200/tempandhumidity", 0),
              (f"dvpg/msa/tower/5/height/200/tempandhumidity", 0), (f"dvpg/msa/tower/6/height/200/tempandhumidity", 0),
              (f"dvpg/msa/tower/7/height/200/tempandhumidity", 0), (f"dvpg/msa/tower/8/height/200/tempandhumidity", 0),
              (f"dvpg/msa/tower/9/height/200/tempandhumidity", 0), (f"dvpg/msa/tower/10/height/200/tempandhumidity", 0),
              (f"dvpg/msa/tower/11/height/200/tempandhumidity", 0), (f"dvpg/msa/tower/12/height/200/tempandhumidity", 0)]

class TempHumidity200SensorData(NamedTuple):
    timestamp: str
    latitude: str
    longitude: str
    Altitude: float
...
def parse_mqtt_message(topic,payload):
    ...
    if sensorType=='soil':
        ...
        return TempHumidity200SensorData(time_stamp, latitude, longitude, altitude, tower, sensorType,measurement,measurement_value1,measurement_value2,measurement_value3,measurement_value4,measurement_value5)
...
outfile=open('./TempHumidity200Data.txt','w')
client = mqtt.Client()
